...
UserList=(function(){
	...
	return{
		...
		add:function(id,u){
			...
			list[id]=u;
			if ((u.color == 2 && My.color != 2)|| (u.color ==3 && My.color != 3)) {
				UserList.addmyuser(u);
			} else {
				var style="";
				var vip_ico="";
...
function MsgShow(str,type){
    ...
    $(document).delegate('.layim_chatsay img', 'click', function() {
        if ($(this).width()>=300||$(this).height()>=300) {
            open_img($(this).attr('src'),1300,800);
        }
    });
    $(document).delegate('.layim_chatsay img', 'mouseover', function() {
        if ($(this).width()>=300||$(this).height()>=300) {
            $(this).attr("title","点击看大图");
            $(this).addClass("chat-pic");
        }
    });
...
// 	var date= Datetime(0);
//
// 	var s='<div style="clear:both;"></div><div class="msg teacher" ><div class="msg_head"><img src="/face/p1/null.jpg"></div><div class="msg_content"><div><font class="u" style="color:#fff" >机器人</font>   <font class="date">&nbsp;&nbsp;'+date+'</font></div> <div class="layim_chatsay"><font style="color:#fff">'+txt+'</font></div></div></div><div style="clear:both;"></div>';
// 	MsgShow(s,0);
// }
function getsysmsg(){
