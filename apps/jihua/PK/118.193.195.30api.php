...
if( $_GET['apiname'] == 'pk10' ){
	// pk10
	$post['pwdfield'] = 'faba97';

	$url = "http://p.softrgb.com/login.aspx?prev=http%3a%2f%2fp.softrgb.com%2fdefault.aspx%3fu%3dmark88888%26t%3dpks%26s%3d2024741eb5&u=mark88888&t=pks&s=2024741eb5"; 

	$cookie = dirname(__FILE__) . '/pk10.txt'; 

	$url2 = "http://p.softrgb.com/PlanData.ashx?u=mark88888&t=pks&s=2024741eb5&d=&random=".time().mt_rand(1000,9999); 
	
} else if( $_GET['apiname'] == 'ssc'){

	// zhixuan
	$post['pwdfield'] = '73fbc6';

	//登录地址 
	$url = "http://p.softrgb.com/login.aspx?prev=http%3a%2f%2fp.softrgb.com%2fdefault.aspx%3fu%3dmark99999%26t%3dcqssc%26s%3d48b7b8a582&u=mark99999&t=cqssc&s=48b7b8a582"; 

	$cookie = dirname(__FILE__) . '/zhixuan.txt'; 
	$url2 = "http://p.softrgb.com/PlanData.ashx?u=mark99999&t=cqssc&s=48b7b8a582&d=&random=".time().mt_rand(1000,9999);
