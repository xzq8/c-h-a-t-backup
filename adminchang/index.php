...
<html lang="en">  
  <head>
    ...
    <title><?=$global['config']['title']?>_后台管理</title>
    ...
    <header class="header navbar navbar-fixed-top" role="banner">
      <div class="container">
        ...
        <ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
          ...
          <li>
            <a href="tongji/todayuser.php" target="main">
              今日访问明细
            </a>
          </li>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
              <a href="/<?=empty($_SESSION['login_roomid'])?$default_roomid:$_SESSION['login_roomid']?>" class="dropdown-toggle" target="_blank" >
          ...
          <ul id="nav">
           <?php if(stripos($auth_rules,'sys_set')!==false){ ?>
            <li class="open">
             ...
             <? }?>
                ...
                <li>
                  <a href="sys/prize.php?getmethod=2" target="main">
                    <i class="icon-angle-right">
                    </i>
                  奖品设置
                  </a>
                ...
                <li>
                    <a href="sys/ip_blacklist.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                  IP黑名单
                  </a>
           ...
           <? }?>
              ...
              <ul class="sub-menu">
                ...
                <li>
                  <a href="rooms/rooms.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    房间列表
                  </a>
                ...
                <li>
                  <a href="rooms/rooms_add.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    添加房间
                  </a>
                ...
                <li>
                  <a href="rooms/room_kefu.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    客服QQ设置
                  </a>
             ...
             <? }?>
              ...
              <ul class="sub-menu">
                  ...
                  <li >
                  <a href="apps/app_plan_bind.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    绑定计划
                  </a>
                ...
                <li>
                  <a href="apps/app_video_list.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    视频库
                  </a>
                ...
                <li>
                  <a href="apps/app_vote.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    投票
                  </a>
                ...
                <li>
                    <a href="apps/app_luckcode_create.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    抽奖码
                  </a>
                ...
                <li>
                  <a href="apps/app_rotate.php?getmethod=2" target="main">
                    <i class="icon-angle-right">
                    </i>
                    抽奖统计
                  </a>
            ...
            <li>
              ...
              <ul class="sub-menu">
                ...
                <?php if(stripos($auth_rules,'ban_users')!==false){ ?>
                 <li>
                  <a href="users/ban_user.php"  target="main">
                    <i class="icon-angle-right">
                    </i>
                      开通发言权限
                  </a>
              ...
              <ul class="sub-menu">
               ...
               <li>
                ...
                <li>
                 ...
                 <li>
                     <a href="tongji/history_online.php" target="main">
                    <i class="icon-eye-open">
                    </i>
                    历史在线
                  </a>
            ...
            <a href="tongji/todayuser.php" target="main">
             ...
             <?php if(stripos($auth_rules,'mobile_guanli')!==false){ ?>   
              ...
              <ul class="sub-menu">
                ...
                <li>
                  <a href="mobile/column.php" target="main">
                    <i class="icon-angle-right">
                    </i>
                    导航栏目
                  </a>
